namespace NexStock.UI
{
	partial class frmLogin
	{
		...
		private void InitializeComponent()
		{
			...
			pnl.CustomizableEdges = customizableEdges15;
			pnl.FillColor = Color.White;
			pnl.Location = new Point(246, 168);
			pnl.Name = "pnl";
			pnl.ShadowDecoration.Color = Color.DimGray;
			pnl.ShadowDecoration.CustomizableEdges = customizableEdges16;
			...
			guna2HtmlLabel5.Size = new Size(263, 17);
			guna2HtmlLabel5.TabIndex = 5;
			guna2HtmlLabel5.Text = "Sua conta é criada pelo administrador so sistema.";
			// 
			// frmLogin
			// 
